...
import {access, chmod, chown, copyFile, type ILinuxSudoOptions, isWindowsPlatform, readFile, rename, stat, unlink, writeFile} from '../src';
...
describe('linux utils', {skip: isWindowsPlatform()}, () => {
